<template>
  <div :class="theme" >
    <header class="screen-header">
      ...
      <span class="title">实时监控一张图</span>
      <div class="title-right">
        <img src="../../assets/img/qiehuan_dark.png" class="qiehuan" @click="themeChange" alt="切换主题" title="切换主题" />
...
import Hot from './echarts/Hot'
import Map from './echarts/Map'
import Rank from './echarts/Rank'
import Seller from './echarts/Seller'
import Stock from './echarts/Stock'
import Trend from './echarts/Trend'
...
export default {
  ...
  methods: {
    ...
    // 接收到服务器切换主题事件
    recvThemeChange() {
      this.$store.commit('changeOneMapTheme')
    },
    currentTime() {
